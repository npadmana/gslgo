...
func TestInteg1(t *testing.T) {
	w := NewWork(1000)
	defer w.Free()
	res, err := Qags(cf, gslgo.Interval{0, 1}, gslgo.Eps{1e-7, 1e-7}, w)
	if err != nil {
...
func TestInteg2(t *testing.T) {
	w := NewWork(1000)
	defer w.Free()
	res, err := Qags(sinf, gslgo.Interval{0, 2 * math.Pi}, gslgo.Eps{1e-7, 1e-7}, w)
	if err != nil {
		t.Errorf("Unexpected error %v", err)
	}
...
func TestInteg3(t *testing.T) {
	w := NewWork(1000)
	defer w.Free()
	res, err := Qags(ep, gslgo.Interval{1, gslgo.Inf}, gslgo.Eps{1e-7, 1e-7}, w)
	y0 := math.Exp(-1)
	if err != nil {
		t.Errorf("Unexpected error %v", err)
	}
...
func TestInteg4(t *testing.T) {
	w := NewWork(1000)
	defer w.Free()
	res, err := Qags(recip, gslgo.Interval{gslgo.NInf, -1}, gslgo.Eps{1e-7, 1e-7}, w)
	y0 := 1.0
	if err != nil {
		t.Errorf("Unexpected error %v", err)
	}
...
func TestInteg5(t *testing.T) {
	w := NewWork(1000)
	defer w.Free()
	res, err := Qags(gauss, gslgo.Interval{gslgo.NInf, gslgo.Inf}, gslgo.Eps{1e-7, 1e-7}, w)
	y0 := 1.0
	if err != nil {
		t.Errorf("Unexpected error %v", err)
	}
